...
/*
 * 修订记录:
 * turalyon@jinvovo.com 2015-12-24 20:48 创建
 *
 */
 ...
 * @version V1.0
 * @Description:
 * @date 2015/12/24 20:48
 */
@Service("defaultServiceRouter")
public class DefaultServiceRouter implements ServiceRouter {
	private static final Logger logger = LoggerFactory.getLogger(DefaultServiceRouter.class);
