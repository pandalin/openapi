...
import com.jvv.openapi.doc.persist.db.domain.ApiScheme;
...
public class ApiDocumentHtmlOutputer implements ApiDocumentOutputer<File> {
	...
	@Override
	public File output(List<ApiServiceDoc> apiServiceDocs, ApidocContext apidocContext) {
		try {
			copyResources();
	 ...
	 * @param apidocContext
	 */
	protected void doParseTop(List<ApiServiceDoc> apiServiceDocs, ApidocContext apidocContext) {
	 ...
	 * @param apiServiceDocs
	 */
	protected void doParseApi(List<ApiServiceDoc> apiServiceDocs) {
		Map<String, Object> map = Maps.newHashMap();
		for (ApiServiceDoc apiServiceDoc : apiServiceDocs) {
	 ...
	 * @param apiServiceDocs
	 */
	protected void doParseMenu(List<ApiServiceDoc> apiServiceDocs) {
		Map<String, Object> map = Maps.newHashMap();
	...
	protected String getApiFileName(ApiServiceDoc apiServiceDoc) {
		StringBuilder fileName = new StringBuilder();
		fileName.append(apiServiceDoc.getService()).append("_v")
