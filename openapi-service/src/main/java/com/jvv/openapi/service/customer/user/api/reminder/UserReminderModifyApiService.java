 ...
 * @time
 */
@OpenApiService(name = "modifyReminder", desc = "修改一条用户设置信息", responseType = ResponseTypeEnum.SYN)
public class UserReminderModifyApiService extends AbstractApiService<UserReminderSettingRequest,ApiResponse>{
	...
	protected void doService (UserReminderSettingRequest request, ApiResponse response) {
		...
		SimpleResult result = userReminderSettingClient.modify (order);
