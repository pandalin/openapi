 ...
 * @time 19:04
 */
@OpenApiService(name = "removeUserFriend", desc = "用户取消关注" , responseType = ResponseTypeEnum.SYN)
public class RemoveUserFriendApiService extends AbstractApiService<UserInfoFriendRequest,ApiResponse> {
	@Resource
	...
	protected void doService (UserInfoFriendRequest request, ApiResponse response) {
		...
		UserInfoFriendResult result = client.removeUserFriend (order);
