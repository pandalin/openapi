 ...
 * @time 16:29
 */
@OpenApiService(name = "deleteGroupHeadImg", desc = "删除群头像接口", responseType = ResponseTypeEnum.SYN)
public class DeleteHeadImgApiService extends AbstractApiService<DeletAndDefaultGroupHeadImgRequest,ApiResponse>{
	...
	protected void doService (DeletAndDefaultGroupHeadImgRequest request, ApiResponse response) {
		...
		SimpleResult result = client.deleteHeadImg (order);
